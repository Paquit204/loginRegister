 ...
 */
public class checkAdminApproval extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        body.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 10, 570, 280));
        ...
        body.add(header6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 140, 280));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(checkAdminApproval.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new checkAdminApproval().setVisible(true);
            }
        });
    }
